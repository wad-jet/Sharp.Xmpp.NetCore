...
namespace Sharp.Xmpp.Client
{
    ...
    public class XmppClient : IDisposable
    {
        ...
        /// </summary>
        public bool RetrieveRooster
        {
            get { return im.RetrieveRooster; }
            set { im.RetrieveRooster = value; }
        }
        ...
        public static async Task<XmppClient> Create(string hostname, int port = 5222, Core.TLSMode tls = Core.TLSMode.StartTLS, string username = null, string password = null, RemoteCertificateValidationCallback validate = null)
        {
            var cli = new XmppClient();

            cli.im = await XmppIm.Create(hostname, port, tls, username, password, validate);
